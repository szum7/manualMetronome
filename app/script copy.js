...
class Example {
    ...
    publicMethod() {
        this.#secretMethod();  // ✅ can call inside the class
    }
}

const e = new Example();
e.publicMethod();  // ✅ works
...
function calculateStartTimeUsec(givenStartUsec, bpm, nowUsec, offsetUsec = 0) {
    const beatPeriodUsec = (60 / bpm) * 1_000_000;
    const adjustedStart = givenStartUsec + offsetUsec;
